...
class TestAuthor:
    ...
    def test_comparison_with_identical_author_ids(self):
        # our specification just asks for the unique id to match for two authors to be the same!
...
class TestBook:
    ...
    def test_construction_modification(self):
        ...
        assert type(book.publisher) == Publisher
    ...
    def test_adding_author(self):
        ...
        assert type(book.authors) == list
        assert type(book.authors[0]) == Author
...
class TestBooksInventory:
    ...
    def test_find_books_successful_check_types(self):
        ...
        assert type(found_book.publisher) is Publisher
        assert type(found_book.authors[0]) is Author
...
class TestBooksJSONReader:
    ...
    def test_read_books_from_file_and_check_other_attributes(self, read_books_and_authors):
        ...
        assert type(dataset_of_books[4].publisher) is Publisher
        assert type(dataset_of_books[4].authors[0]) is Author
